...
public class PrimeiraController {
	...
	@GetMapping("/metodoComQueryParamsAll")
	public String metodoComQueryParamsAll(@RequestParam Map<String, String> allParams) {
		return "O parâmetro com metodoComQueryParamsAll é " + allParams.entrySet();
	}
	...
	private record Usuario(String username) {
	}

	@PostMapping("/metodoComBodyParams")
	public String metodoComBodyParams(@RequestBody Usuario usuario) {
		return "O parâmetro com metodoComBodyParams é " + usuario.username();
	}
